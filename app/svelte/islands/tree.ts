// islands/tree.ts - the drawer island's mount surface.
//
...
export function mountDocTree(target: Element, onSelect: (id: string) => void): void {
  mount(DocTree, { target: target, props: { onSelect: onSelect } });
}

export function mountSearchHits(target: Element, onSelect: (id: string) => void): void {
