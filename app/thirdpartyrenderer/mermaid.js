...
function loadLib() {
    ...
    libPromise = new Promise((resolve, reject) => {
        ...
        s.onerror = () => reject(new Error('Mermaid library not found. Place mermaid.min.js in thirdpartyrenderer/ ' +
...
let seq = 0;
registerBlockRenderer('mermaid', async (source) => {
    ...
    if (svgEl) {
        ...
        if (naturalW)
            svgEl.style.width = Math.round(naturalW) + 'px';
    }
