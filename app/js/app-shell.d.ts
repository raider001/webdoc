 ...
 */
export declare function titleFromId(id: string): string;
/**
 ...
 */
export declare function defaultId(): string | undefined;
/**
 ...
 */
export declare function docFromId(id: string): Doc | null;
/**
 * Resolve an id to a cached doc, or a fresh stub (cached for reuse). Shared by
 * the router (route) and authoring (deleteDocFlow).
 */
export declare function getDoc(id: string): Doc | null | undefined;
/**
 * Download a string as a file (self-contained report), no server round-trip.
 */
export declare function downloadFile(filename: string, text: string, mime?: string): void;
...
export declare const app: AppRegistry;
