 ...
 */
export declare function iconBtn(icon: Element | null, title: string, onClick: (e: MouseEvent) => void): HTMLElement;
/**
 * @param content text, an icons.js node, or a mix - a ChildSlot, i.e. exactly
 *   what the elem() call below forwards it into
 */
export declare function smallBtn(content: ChildSlot, onClick: (e: MouseEvent) => void): HTMLElement;
