 ...
 */
export function inlineMarkdown(text: unknown): DocumentFragment {
 ...
 */
export function blockMarkdown(text: unknown): DocumentFragment {
 ...
 * that catches it.
 */
function mountBlocks(mod: IslandModule, pending: PendingMount[]): void {
 ...
 */
export function renderRequirements(article: Element, docId: string): void {
