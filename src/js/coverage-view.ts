...
import type { CoverageResults, CoverageStatus, TestEvidence } from './coverage.js';
...
export interface TestReportData {
  ...
  detail: ({ id: string } & TestEvidence & { run: TestRunMeta | null })[];
}
 ...
 * with.
 */
export function setupCoverageView(): OverlayHandle {
  const btn = el('covBtn');
   ...
   */
  let results: CoverageResults | null = null;
